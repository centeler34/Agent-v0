...
export const DESCRIPTION = 'Get or set Agent v0 configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Agent v0 configuration settings.

  View or change Agent v0 settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
