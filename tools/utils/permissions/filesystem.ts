...
// Always ask when Agent v0 tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Agent v0 for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Agent v0)
