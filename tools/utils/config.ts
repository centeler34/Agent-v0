...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Agent v0 was first started on this machine
  ...
  // Agent v0 usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Agent v0 OAuth token
  ...
  // Agent v0 hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
