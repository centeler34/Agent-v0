...
/**
 * Resolve Agent v0-specific path patterns for sandbox-runtime.
 *
 * Agent v0 uses special path prefixes in permission rules:
...
/**
 * Convert Agent v0 settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Agent v0 started)
